      ...
      >
        ...
        <ul class="space-y-4 text-sm text-gray-300 leading-relaxed italic">
          <li class="flex gap-3">
            ...
            <p>
              Siamo in avvicinamento alla Luna. La quota target del nostro
              parcheggio è <span class="text-white font-bold">100 km</span> dalla
              superficie.
            </p>
          </li>
          <li class="flex gap-3">
            ...
            <div class="flex-1">
              <p>
                Calcola la velocità dell'orbita circolare <span
                  class="text-white font-bold">(v_circ)</span
                > a quell'altitudine (r = R_Luna + h).
              </p>
              <div
              ...
              >
                <div
                  use:math={{
                    expression: "v_{circ} = \\sqrt{\\frac{GM_{Luna}}{r}}",
                    displayMode: true,
                  }}
                ></div>
              </div>
          ...
          <li class="flex gap-3">
            ...
            <p>
              Il <span class="text-white font-bold">Δv</span> sarà la differenza
              tra la tua attuale velocità d'arrivo (V_iperbolica) e la velocità calcolata
              (v_circ). Poiché stiamo frenando, questo valore rappresenta una decelerazione.
            </p>
          </li>
        </ul>
        <button
  ...
  <div class="w-1/3 bg-nasa-blue/5 border-r border-white/10 p-8">
    ...
    <div class="space-y-4 font-mono text-[11px]">
      <div class="p-3 bg-white/5 rounded-lg border border-white/5">
        ...
        <p class="text-white">1737 km</p>
      </div>
      <div class="p-3 bg-white/5 rounded-lg border border-white/5">
        <p class="text-gray-500 mb-1">Quota Target (h)</p>
        <p class="text-white">100 km</p>
      </div>
      <div class="p-3 bg-white/5 rounded-lg border border-white/5">
      ...
      {#if teacherMode}
        ...
        >
          ...
          <p class="text-white text-[10px]">
            Δv Target (frenata): <span class="text-yellow-400">~880 m/s</span>
          </p>
          <p class="text-gray-400 text-[9px] mt-1 italic">
            V_arr = 2515 m/s | V_circ = 1634 m/s
          </p>
        </div>
      {/if}
    </div>
        ...
        {#if isConfirmed}
          ...
          >
            ...
            <p class="text-xs font-mono uppercase tracking-widest">
              Sequenza LOI Validata. Motori pronti.
            </p>
          </div>
        {/if}
      </div>
