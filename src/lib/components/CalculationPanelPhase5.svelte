      ...
      >
        ...
        <ul class="space-y-4 text-sm text-gray-300 leading-relaxed italic">
          <li class="flex gap-3">
            ...
            <p>
              La navicella si trova attualmente in un'orbita circolare lunare a <span
                class="text-white font-bold">100 km</span
              > di altezza (r = 1.837.000 m).
            </p>
          </li>
          <li class="flex gap-3">
            ...
            <div class="flex-1">
              <p>
                Calcola o ricorda la velocità circolare (v_circ) per questa
                quota.
              </p>
            </div>
          </li>
          <li class="flex gap-3">
            ...
            <div class="flex-1">
              <p>
                Per fuggire alla gravità, la velocità deve raggiungere la <span
          ...
          <li class="flex gap-3">
            ...
            <p>
              Il <span class="text-white font-bold">Δv</span> è l'accelerazione necessaria:
              la differenza tra la v_esc calcolata e la tua v_circ attuale.
            </p>
          </li>
        </ul>
        <button
      ...
      {#if teacherMode}
        ...
        >
          ...
          <p class="text-white text-[10px]">
            Δv Target (spinta TEI): <span class="text-yellow-400">~676 m/s</span
            >
          </p>
          <p class="text-gray-400 text-[9px] mt-1 italic">
            V_esc = 2310 m/s | V_circ = 1634 m/s
          </p>
        </div>
      {/if}
    </div>
        ...
        {#if isConfirmed}
          ...
          >
            ...
            <p class="text-xs font-mono uppercase tracking-widest">
              Sequenza TEI Validata. Rotta di fuga impostata.
            </p>
          </div>
        {/if}
      </div>
